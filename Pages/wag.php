...
?>
    <title>Dinder - Wag</title>
    <!-- style -->
    <link rel="stylesheet" href="../Style/profile.css">
    <link rel="stylesheet" href="../Style/wag.css">
...
<body>
    ...
    <div class="profile-wrapper">
        ...
        <div class="profile-banner">
            <form class="profile-banner-form" action="../php/wag.php" method="post">
                <div class="profile-banner-image" style="background-image: url(' <?php if($bannerpic != null){ echo $bannerpic; }else{ echo "../Images/section1dog.png"; } ?> ');">
                    <div class="wag-swipe-button wag-swipe-left"><button type="submit" name="swipeleft" value="<?php echo $_GET["user"] ?>"><i class="fa-solid fa-angle-left"></i></button></div>
                    ...
                    <div class="wag-swipe-button wag-swipe-right"><button type="submit" name="swiperight" value="<?php echo $_GET["user"]?>"><i class="fa-solid fa-angle-right"></i></button></div>
                </div>
            </form>
        </div>
